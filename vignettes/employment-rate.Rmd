...
markets in recent memory. However, this pattern isn't uniform — rural counties anchored
by large employers or adjacent to metro areas can rival nonrural peers — but the
central tendency is clear and durable.

The cross-package approach used here gives a cleaner picture of labor market health
