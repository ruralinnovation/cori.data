...
A simple `mean()` treats every county equally — a county with 200
workers gets exactly the same weight as one with 200,000. In practice,
the result is dominated by hundreds of small, low-employment rural
counties that collectively represent a tiny fraction of the actual rural
workforce.
