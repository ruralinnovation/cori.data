...
-   [**Employment Rate**](employment-rate.html) — combine QCEW + PEP to
    build a cross-package employment rate with line chart and county map
-   [**Working with Tidy Data**](tidy-data.html) — filtering, pivoting
    wide, and joining datasets across packages
-   [**Sector Analysis**](sector-analysis.html) — CORI super-sectors and
    what they reveal about rural economic composition
-   [**Weighted Averages**](weighted-averages.html) — why `agg_var`
    matters and how to use it correctly
-   [**Broadband**](broadband.html) — FCC broadband data and its
