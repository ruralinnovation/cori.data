---
title: "Getting Started with CORI Rural Data"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with CORI Rural Data}
...
Rural America contains multitudes. It is a place of deep economic resilience
and persistent structural challenge — where the loss of a single employer can
reshape a community for a generation, and where a new business opening can
signal something much larger than its balance sheet.

The CORI data ecosystem gives researchers, analysts, and practitioners direct
access to the socioeconomic data that describes these dynamics. This vignette
introduces the ecosystem and the consistent interface that runs across every
package.
...
Every package uses the same four parameters. Once you learn the pattern once,
...
- **[Employment Rate](employment-rate.html)** — combine QCEW + PEP to build a
  cross-package employment rate with line chart and county map
- **[Working with Tidy Data](tidy-data.html)** — filtering, pivoting wide,
  and joining datasets across packages
- **[Sector Analysis](sector-analysis.html)** — CORI super-sectors and
  what they reveal about rural economic composition
- **[Weighted Averages](weighted-averages.html)** — why `agg_var` matters
  and how to use it correctly
- **[Broadband](broadband.html)** — FCC broadband data and its relationship
