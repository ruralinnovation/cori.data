...
-   **CORI supersectors** — a CORI-designed aggregation into 3 categories based on whether industries primarily face local or national/global demand
...
Pay varies substantially across sectors. Use `get_sector_wages()` to see which sectors drive higher or lower wage outcomes:
