...
cori.db::get_s3_object(s3_bucket_name, paste0(data_prefix, "/cb_2024_us_county_500k.zip"), "inst/ext_data/test/cb_2024_us_county_500k.zip")

cori.db::get_s3_object(s3_bucket_name, paste0(data_prefix, "/tl_2024_us_county.zip"), "inst/ext_data/test/tl_2024_us_county.zip")
